...
export default function FixedPlugin(props) {
    ...
    const handleClick = () => props.handleFixedClick();
    return (
                ...
                <ul className="dropdown-menu">
                    ...
                    <li className="adjustments-line">
                        <a className="switch-trigger">
                            <div>
                <span className={props.bgColor === "purple" ? "badge filter badge-purple active" : "badge filter badge-purple"}
                      data-color="purple"
                      onClick={() => props.handleColorClick("purple")}/>
                                ...
                                <span className={
                                    props.bgColor === "orange"
                                      ...
                                      data-color="orange"
                                      onClick={() => props.handleColorClick("orange")}/>
                            </div>
                        </a>
                    </li>
